...
class PuzzleGenerator implements PuzzleSource {
     ...
     *  encountered. */
    /** fix: Set nFound to the number of squares in the
    ...
    /**@param model is an object model of type Model
     * @return: result of forward connections */
    ...
    /** fix: Set nFound to the number of squares that are
     ...
     *  is numbered, then set nFound to 1 and found to that
     *  numbered predecessor.
     */

    /**@param model is an object model of type Model
     * @return result of backward connections */
